            ...
            <footer class="tm-bg-dark-blue">
                <div class="container">
                    <div class="row">
                        ...
                        - Design: <a href="#/tooplate" class="tm-color-primary tm-font-normal" target="_parent">Tooplate</a>.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>        
                    </div>
                </div>                
            </footer>
        </div>
